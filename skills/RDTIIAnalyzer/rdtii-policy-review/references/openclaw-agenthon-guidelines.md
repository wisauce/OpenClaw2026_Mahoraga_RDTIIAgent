# OpenClaw Agenthon 2026 guidelines for RDTII Agent / Team Mahoraga packaging
...
Use this reference when packaging, documenting, demoing, or submission-checking an RDTII Hermes Agent such as RDTII Agent from Team Mahoraga for the hackathon.
...
## RDTII Agent / Team Mahoraga positioning checklist
...
- A README that states the unique RDTII Agent skill is under `skills/RDTIIAnalyzer/`; other skills are bundled Hermes skills.
