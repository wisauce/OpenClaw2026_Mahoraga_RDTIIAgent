# Agenthon Compliance Checklist for Mahoraga

This checklist translates the RISTEK x Build Club OpenClaw Agenthon 2026 technical guidelines into concrete Mahoraga profile requirements.

## Required agent behavior

- [x] **AI Agent / Multi-Agent System**: Mahoraga is a Hermes Agent profile with domain persona, skills, memory, toolsets, and optional delegation.
...
Use a short policy excerpt or public policy URL and ask Mahoraga to:
...
- **0:15–0:35**: Show Mahoraga as a Hermes profile with unique `RDTIIAnalyzer` skill.
...
2. **Solution Overview** — Mahoraga, a domain-specific Hermes Agent for RDTII review.
